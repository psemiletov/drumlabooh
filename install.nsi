...
Section "Files (mandatory)"
  ...
  SetOutPath $INSTDIR
  ; Put file there
  File /r ".\build\drumlabooh_artefacts\Release\VST3\drumlabooh.vst3\drumlabooh.vst3/Contents/Resources/moduleinfo.json"
  File /r ".\build\drumlabooh_artefacts\Release\VST3\drumlabooh.vst3\drumlabooh.vst3/Contents/x86_64-win/drumlabooh.vst3"
